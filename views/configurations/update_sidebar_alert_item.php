...
<div class="border-0 p-2 alert w-100 alert-<?php if(isset($args['type'])) printf('%s', wp_kses_post($args['type'])); ?>" style="<?php if(isset($args['css'])) printf('%s', wp_kses_post($args['css'])); ?>">
